 ...
 * Decoupled from the full Session class to avoid heavy imports.
 */
export interface BangSessionLike {
    sessionId?: string | null;
    /** Session mode: local terminal vs remote-controlled */
    mode?: 'local' | 'remote';
}
...
export interface BangCommandContext {
    ...
    /** Current agent session (may be null during startup) */
